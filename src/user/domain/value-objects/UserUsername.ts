...
export class UserUsername {
  ...
  private ensureIsValid() {
    ...
    if (usernameLength < USERNAME_CHAR_LOWER_LIMIT) throw new UserUsernameIsTooShortError(this.value);
    if (usernameLength > USERNAME_CHAR_UPPER_LIMIT) throw new UserUsernameIsTooLongError(this.value);
