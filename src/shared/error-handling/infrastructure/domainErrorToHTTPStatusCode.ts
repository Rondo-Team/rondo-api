...
export const domainErrorToHTTPStatusCode: Record<DomainErrorCode, HttpStatus> = {
  ...
  [DomainErrorCode.LIKE_WITH_USER_AND_POST_NOT_FOUND]: HttpStatus.NOT_FOUND,
  [DomainErrorCode.PROPOSAL_IS_ALREADY_CLOSED]: HttpStatus.BAD_REQUEST,
  [DomainErrorCode.PROPOSAL_HISTORY_ENTRIE_INTENT_INVALID_ERROR]: HttpStatus.BAD_REQUEST,
  [DomainErrorCode.PROPOSAL_HISTORY_ENTRIE_REQUIRES_PAYLOAD_ERROR]: HttpStatus.BAD_REQUEST,
}